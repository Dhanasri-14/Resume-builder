    ...
    <div className='space-y-4'>
      ...
      <div className='flex gap-2'>
        <input
          ...
          className='flex-1 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors'
      ...
      <div className='bg-blue-50 p-3 rounded-lg'>
        <p className='text-sm text-blue-800'>
          <strong>Tip:</strong> Add 8–12 relevant skills. Include both technical (programming languages, tools)
